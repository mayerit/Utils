...
Public Property Get EndOfInput() As Boolean
    EndOfInput = VirtualKeys(VK_ESCAPE).VKPressed _
                Or VirtualKeys(VK_ESCAPE).VKToggle
End Property
Public Property Let EndOfInput(ByVal newval As Boolean)
    VirtualKeys(VK_ESCAPE).VKToggle = newval
End Property
Public Property Get Toggled(ByVal vkCode As Long) As Boolean
    Toggled = VirtualKeys(vkCode).VKToggle
End Property
Public Property Let Toggled(ByVal vkCode As Long, ByVal newval As Boolean)
    VirtualKeys(vkCode).VKToggle = newval
End Property
Public Property Get Pressed(ByVal vkCode As Long) As Boolean
    Pressed = VirtualKeys(vkCode).VKPressed
End Property
Public Property Let Pressed(ByVal vkCode As Long, ByVal newval As Boolean)
    VirtualKeys(vkCode).VKPressed = newval
End Property
